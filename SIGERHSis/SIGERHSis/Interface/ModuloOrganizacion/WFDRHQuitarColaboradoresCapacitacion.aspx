<%@ Page Title="" Language="C#" MasterPageFile="~/Interface/Capacitaciones.Master" AutoEventWireup="true" CodeBehind="WFDRHQuitarColaboradoresCapacitacion.aspx.cs" Inherits="SIGERHSis.Interface.ModuloOrganizacion.WFDRHQuitarColaboradoresCapacitacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="tables" style="font-family: 'Segoe UI'">
            <div>
                ...
                <br />
                <asp:Button ID="btnQuitarColaboradores" runat="server" 
                    Text="Quitar Colaboradores" onclick="btnQuitarColaboradores_Click" />
            </div>
            <div>
