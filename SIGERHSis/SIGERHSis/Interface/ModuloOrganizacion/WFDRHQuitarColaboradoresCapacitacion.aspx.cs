...
{
    public partial class WFDRHQuitarColaboradoresCapacitacion : System.Web.UI.Page
    {
        ...
        protected void DropDownListProyectos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cargarColaboradores(_capacitacionActual.Id);
        }
        private void cargarColaboradores(int pIdCapacitacion)
        {
            
            List<Colaborador> colaboradores = controladorOrganizacion.obtenerColaboradoresCapacitacion(pIdCapacitacion);
        ...
        private string obtenerColaboradoresSeleccionados()
        {
            ...
            colaboradoresProyecto = controladorOrganizacion.obtenerColaboradoresCapacitacion(_capacitacionActual.Id);
