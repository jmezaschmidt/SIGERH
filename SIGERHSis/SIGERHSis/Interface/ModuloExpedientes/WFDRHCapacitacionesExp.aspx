<%@ Page Title="" Language="C#" MasterPageFile="~/Interface/WFDRHExpediente.Master" AutoEventWireup="true" CodeBehind="WFDRHCapacitacionesExp.aspx.cs" Inherits="SIGERHSis.Interface.ModuloExpedientes.WFDRHCapacitacionesExp" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblDescripcionInfo" runat="server" Text="decripcion"></asp:Label>
    </div>
</asp:Content>