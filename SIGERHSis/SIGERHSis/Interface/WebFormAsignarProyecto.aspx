<%@ Page Title="" Language="C#" MasterPageFile="~/TemplatePage.Master" AutoEventWireup="true" CodeBehind="WebFormAsignarProyecto.aspx.cs" Inherits="SIGERHSis.Interface.WebFormAsignarProyecto" %>
...
<div style="float: left; width: 49%;">
    ...
    <div style="float: right; width: 50%;">
        ...
        <asp:Label ID="Label3" runat="server" 
            ...
            Text="Proyecto a asignar"></asp:Label>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="ButtonAsignarProyecto" runat="server" Text="Asignar Proyecto" 
            style="font-family: Arial, Helvetica, sans-serif" />
