CREATE PROCEDURE [dbo].[sp_verSolicitudesDepartamento]
...
BEGIN
	BEGIN TRY
		...
		TipoSolicitud, motivo, fechaInicial, fechaFinal, EstadoSolicitud
		...
		INNER JOIN dbo.Departamento ON idDepartamento = FK_idDepartamento where Departamento.nombre = @nombre
